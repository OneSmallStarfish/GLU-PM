...
def init_logging(LOGGER):
    ...
    file_handler = logging.FileHandler('./output/pretrain_task/SecureCorpus.log')
...
def parse_args():
    ...
    args.add_argument("-train_data", "--train_data", type=str,
                      default="./datasets/tasks/SecureCorpus/SecureCorpus_train.json", help="train dataset")
    args.add_argument("-dev_data", "--dev_data", type=str,
                      default="./datasets/tasks/SecureCorpus/SecureCorpus_dev.json", help="dev dataset")
    args.add_argument("-test_data", "--test_data", type=str,
                      default="./datasets/tasks/SecureCorpus/SecureCorpus_test.json", help="test dataset")
...
def evaluate(args):
    ...
    dev_evaluator = LabelAccuracyEvaluator(dev_dataloader, softmax_model=train_loss, name='SecureCorpus_dev')
    test_evaluator = LabelAccuracyEvaluator(test_dataloader, softmax_model=train_loss, name='SecureCorpus_test')
